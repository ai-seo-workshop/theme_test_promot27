                    ...
                    <div class="flex-grow-1">
                        <div class="home-right-card">
                            <a href="<?php echo e($hotBlog->category->url); ?>">
                                <span class="badge <?php echo e(\App\Models\Category::buttonClass($hotBlog->category->slug)); ?>  mb-2"><?php echo e($hotBlog->category_name); ?></span>
                            </a>
                            ...
                            <div class="blog-card-img-wrapper">
                                ...
                                <div class="blog-card-overlay">
                                    ...
                                    <a href="<?php echo e($blog->url); ?>" class="text-decoration-none">
                                        <p class="h5 mb-2 category-article-title"><?php echo e($blog->title); ?></p>
                                    </a>
            ...
            <div class="col-md-6 mb-3">
                <div class="align-items-center border rounded-3 p-3 hover-shadow">
                    <div class="latest-card">
                        <a href="<?php echo e($latestBlog->category->url); ?>"><span class="badge <?php echo e(\App\Models\Category::buttonClass($latestBlog->category->slug)); ?> mb-2"><?php echo e($latestBlog->category_name); ?></span></a>
                    ...
                    <div class="h6 mb-0"><?php echo e($latestBlog->title); ?></div>
                    </a>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/work/php/blog_howencyclopedia_site/resources/views/home.blade.php ENDPATH**/ ?>