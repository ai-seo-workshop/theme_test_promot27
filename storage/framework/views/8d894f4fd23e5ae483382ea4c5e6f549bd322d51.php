    ...
    [
        {
            ...
            "headline": "<?php echo str_replace("\"", "\\\"", $blog->title); ?>",
            "datePublished": "<?php echo e(date("Y-m-d\TH:i:sP", strtotime($blog->published_at))); ?>",
            "dateModified": "<?php echo e(date("Y-m-d\TH:i:sP", strtotime($blog->published_at))); ?>",
            "description": "<?php echo str_replace("\"", "\\\"", $blog->summary); ?>",
            "image": {
                "@type": "ImageObject",
        ...
        <?php if(!empty($blog->faq)): ?>,
        {
            ...
            "mainEntity": [
                ...
                [
                   {
                       "@type": "Question",
                       "name": "<?php echo str_replace("\"", "\\\"", $faq['question']); ?>",
                           "acceptedAnswer": [
                               {
                                   "@type": "Answer",
...
<body>
    ...
    <footer class="footer">
        <div class="container message">
            <div>
                <p class="footer-title"><i class="fas fa-gift"></i> <?php echo e(config('app.name')); ?></p>
                <p><?php echo e(\App\Models\MaterielTask::slogan(app()->getLocale())); ?></p>
            </div>

            <div>
                <p class="footer-title"><?php echo e(\App\Models\MaterielTask::quickLinks(app()->getLocale())); ?></p>
            ...
            <div>
                <p class="footer-title"><?php echo e(\App\Models\MaterielTask::categoryName(app()->getLocale())); ?></p>
                <ul class="list-unstyled">
        ...
        <div class="footer-bottom container">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.domain')); ?>. All rights reserved.</p>
        </div>
    </footer>
...
<?php /**PATH /Library/WebServer/Documents/work/php/blog_howencyclopedia_site/resources/views/layout.blade.php ENDPATH**/ ?>