                                    ...
                                    <li class="sidebar-item">
                                        <a href="<?php echo e($popularBlog->url); ?>" class="d-flex align-items-start">
                                            <img src="<?php echo e($popularBlog->head_img); ?>"
                                                 alt="<?php echo e($popularBlog->head_img_alt); ?>"
                                                 class="sidebar-thumb me-2">
                                            <div class="flex-grow-1">
                                                <p class="sidebar-post-title"><?php echo $popularBlog->title; ?></p>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <article class="blog-card">
                                    <div class="blog-card-img-wrapper">
                                        <img src="<?php echo e($relatedBlog->head_img); ?>" alt="<?php echo e($relatedBlog->head_img_alt); ?>">
                                    </div>
                                    <div class="blog-card-body">
                                        <a href="<?php echo e($relatedBlog->url); ?>" class="text-decoration-none">
                                            <p class="blog-card-title"><?php echo $relatedBlog->title; ?></p>
                                        </a>
                                        <p class="blog-card-text"><?php echo $relatedBlog->summary; ?></p>
                                    </div>
                                </article>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/work/php/blog_techlysupport_site/resources/views/blog-detail.blade.php ENDPATH**/ ?>